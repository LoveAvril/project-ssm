			...
			<el-row>
				<el-col>
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<!-- 员工用户 -->
						<form_employee_user v-if="form.user_group === '员工用户'" :form="form_sub" ></form_employee_user>
						<!-- 财务用户 -->
						<form_financial_user v-if="form.user_group === '财务用户'" :form="form_sub" ></form_financial_user>
...
<script>
	...
	/* 员工用户 */
	import form_employee_user from "@/components/diy/form_employee_user";
	/* 财务用户 */
	import form_financial_user from "@/components/diy/form_financial_user";
